...
#eg: http://oireachtasdebates.oireachtas.ie/debates%20authoring/debateswebpack.nsf/takes/seanad2014111300001
## replace the four digits before '?opendocument' with the appropriate digits to indicate page number
...
day1_url = single_days[1][3] ## url column of the 2nd row
